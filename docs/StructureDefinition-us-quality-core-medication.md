...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-medication | *Version*:0.5.0 |
| Active as of 2026-06-05 | *Computable Name*:USQualityCoreMedication |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      {
        "code" : "Reference",
        "targetProfile" : ["http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-substance|0.5.0",
