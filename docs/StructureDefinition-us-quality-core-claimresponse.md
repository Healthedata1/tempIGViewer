...
* **US Quality Core ClaimResponse**

## Resource Profile: US Quality Core ClaimResponse 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-claimresponse | *Version*:0.5.0 |
| Draft as of 2026-06-05 | *Computable Name*:USQualityCoreClaimResponse |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-claim|0.5.0"]
      }],
      "isModifier" : false,
      "isSummary" : true
    },
