...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-allergyintolerance | *Version*:0.5.0 |
| Active as of 2026-06-05 | *Computable Name*:USQualityCoreAllergyIntolerance |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/allergyintolerance-resolutionAge|4.0.1"]
      }],
      "mustSupport" : false
    },
    {
