...
* **US Quality Core Do Not Perform Reason**

## Extension: US Quality Core Do Not Perform Reason 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-doNotPerformReason | *Version*:0.5.0 |
| Active as of 2026-06-05 | *Computable Name*:USQualityCoreDoNotPerformReason |
