...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-familymemberhistory | *Version*:0.5.0 |
| Active as of 2026-06-05 | *Computable Name*:USQualityCoreFamilyMemberHistory |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/familymemberhistory-abatement|4.0.1"]
      }],
      "mustSupport" : false
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/familymemberhistory-severity|4.0.1"]
      }],
      "mustSupport" : false,
      "binding" : {
        "strength" : "preferred",
