...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile OrganizationRole
  ...
  -->
  <sch:pattern>
    <sch:title>f:OrganizationRole</sch:title>
  ...
  <sch:pattern>
    <sch:title>OrganizationRole.extension</sch:title>
    <sch:rule context="f:OrganizationRole/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), 'value')])">Must have either extensions or value[x], not both (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:OrganizationRole/f:identifier</sch:title>
    <sch:rule context="f:OrganizationRole/f:identifier">
  ...
  <sch:pattern>
    <sch:title>f:OrganizationRole/f:identifier/f:extension</sch:title>
    <sch:rule context="f:OrganizationRole/f:identifier/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:OrganizationRole/f:telecom</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:OrganizationRole/f:telecom/f:extension</sch:title>
    <sch:rule context="f:OrganizationRole/f:telecom/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:OrganizationRole/f:telecom/f:extension/f:extension</sch:title>
    <sch:rule context="f:OrganizationRole/f:telecom/f:extension/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:valueCode) &gt;= 1">valueCode: minimum cardinality of 'valueCode' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>OrganizationRole.availableTime</sch:title>
    <sch:rule context="f:OrganizationRole/f:availableTime">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>OrganizationRole.notAvailable</sch:title>
    <sch:rule context="f:OrganizationRole/f:notAvailable">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
