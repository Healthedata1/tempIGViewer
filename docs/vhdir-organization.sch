...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Organization">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/ig/vhdir/StructureDefinition/org-description']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/ig/vhdir/StructureDefinition/org-description': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Organization/f:alias">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/ig/vhdir/StructureDefinition/org-alias-type']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/ig/vhdir/StructureDefinition/org-alias-type': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/ig/vhdir/StructureDefinition/org-alias-period']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/ig/vhdir/StructureDefinition/org-alias-period': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
