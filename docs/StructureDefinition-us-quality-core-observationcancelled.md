...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-observationcancelled | *Version*:0.5.0 |
| Active as of 2026-06-05 | *Computable Name*:USQualityCoreObservationCancelled |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-notDoneReason|0.5.0"]
      }]
    },
    {
