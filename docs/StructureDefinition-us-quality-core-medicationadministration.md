...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-medicationadministration | *Version*:0.5.0 |
| Draft as of 2026-06-05 | *Computable Name*:USQualityCoreMedicationAdministration |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      {
        "code" : "Reference",
        "targetProfile" : ["http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-medication|0.5.0"]
      }],
      "binding" : {
        "strength" : "preferred",
