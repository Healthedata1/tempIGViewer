...
* **US Quality Core MedicationStatement**

## Resource Profile: US Quality Core MedicationStatement 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-medicationstatement | *Version*:0.5.0 |
| Active as of 2026-06-05 | *Computable Name*:USQualityCoreMedicationStatement |
