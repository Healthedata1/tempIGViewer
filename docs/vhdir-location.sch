...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Location">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/ig/vhdir/StructureDefinition/newpatients']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/ig/vhdir/StructureDefinition/newpatients': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Location/f:identifier/f:extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Location/f:telecom/f:extension/f:extension</sch:title>
    <sch:rule context="f:Location/f:telecom/f:extension/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:valueCode) &gt;= 1">valueCode: minimum cardinality of 'valueCode' is 1</sch:assert>
