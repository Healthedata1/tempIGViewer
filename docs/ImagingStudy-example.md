# ImagingStudy example - 2026 US Quality Core Implementation Guide v0.5.0
...
```json
{
  ...
  "id" : "example",
  "meta" : {
    "profile" : ["http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-imagingstudy"]
  },
  "status" : "available",
  "subject" : {
