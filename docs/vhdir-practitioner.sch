...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:identifier/f:extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:address/f:extension/f:extension</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner/f:qualification">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/ig/vhdir/StructureDefinition/practitioner-qualification']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/ig/vhdir/StructureDefinition/practitioner-qualification': maximum cardinality of 'extension' is 1</sch:assert>
