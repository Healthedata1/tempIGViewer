# US Quality Core Examples - 2026 US Quality Core Implementation Guide v0.5.0

* [**Table of Contents**](toc.md)
* **US Quality Core Examples**
...
* [Professional Claim for Appendectomy](Claim-example.md)

**USQualityCoreClaimResponse**

* [Professional ClaimResponse for Appendectomy](ClaimResponse-example.md)

**USQualityCoreCommunication**

* [Radiology Report Notification Example](Communication-example.md)
...
* [ECG Monitor Use by a Patient Example](DeviceUseStatement-example.md)
...
* [Fall Risk Safety Flag Example](Flag-example.md)
...
* [Example of entered-in-error Influenza immunization record](Immunization-statusreason-example.md)
...
* [Alemtuzumab MedicationDispense Example](MedicationDispense-example.md)
* [Alemtuzumab MedicationDispense Course Example](MedicationDispense-cmd-example.md)
...
* [Alemtuzumab MedicationRequest Example](MedicationRequest-example.md)
...
* [Alemtuzumab MedicationStatement Example](MedicationStatement-example.md)
...
* [PHQ-9 Questionnaire Response Example](QuestionnaireResponse-PHQ-9-example.md)
...
* [Negation Example with valueset](Observation-negation-example.md)
* [Negation Example with code](Observation-negation-with-code-example.md)
...
* [Negation Example with valueset](Procedure-negation-example.md)
...
* [ODH Example](Observation-example-odh.md)
