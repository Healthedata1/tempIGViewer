...
* **US Quality Core BodyStructure**

## Resource Profile: US Quality Core BodyStructure 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-bodystructure | *Version*:0.5.0 |
| Active as of 2026-06-05 | *Computable Name*:USQualityCoreBodyStructure |
