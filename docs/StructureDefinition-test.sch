...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>SupplyRequest.item[x].extension 1</sch:title>
    <sch:rule context="f:SupplyRequest/f:item[x]/f:extension">
  ...
  <sch:pattern>
    <sch:title>SupplyRequest.item[x].reference 1</sch:title>
    <sch:rule context="f:SupplyRequest/f:item[x]/f:reference">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>SupplyRequest.item[x].type 1</sch:title>
    <sch:rule context="f:SupplyRequest/f:item[x]/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>SupplyRequest.item[x].identifier 1</sch:title>
    <sch:rule context="f:SupplyRequest/f:item[x]/f:identifier">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>SupplyRequest.item[x].display 1</sch:title>
    <sch:rule context="f:SupplyRequest/f:item[x]/f:display">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
