...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-encounter | *Version*:0.5.0 |
| Active as of 2026-06-05 | *Computable Name*:USQualityCoreEncounter |
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-immunizationrecommendation|0.5.0"]
      }],
      "isModifier" : false,
      "isSummary" : true
    },
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-encounter-diagnosisPresentOnAdmission|0.5.0"]
      }],
      "condition" : ["ele-1"],
      "constraint" : [{
        "key" : "ele-1",
