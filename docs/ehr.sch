...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'developer']) &lt;= 1">extension with URL = 'developer': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'certificationEdition']) &lt;= 1">extension with URL = 'certificationEdition': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'certificationID']) &lt;= 1">extension with URL = 'certificationID': maximum cardinality of 'extension' is 1</sch:assert>
